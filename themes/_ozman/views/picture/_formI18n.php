<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <div class="buttons">
      	<a onclick="$('#picture-form').submit();" class="button"><?php  echo Yii::t('app', 'Save'); ?></a>
      	<?php if($returnUrl = Yii::app()->user->getState('picture-grid-url')):?>
    ...
    <div class="content">
		...
		<?php
			if($returnUrl = Yii::app()->user->getState('picture-grid-url')){
