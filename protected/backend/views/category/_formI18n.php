<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
		...
		?>
		<div id="tab-basic">
			<?php  echo $this->renderPartial('_basic', array('form' => $form, 'model' => $model, 'categories' => $categories), true)?>
		</div>

		<?php  foreach($this->languages as $val):?>
		<div id="tab-language-<?php  echo $val['language_id']?>">
			<?php  echo $this->renderPartial('//categoryI18n/_i18n', array('form' => $form, 'model' => $i18ns[$val['language_id']], 'language_id' => $val['language_id']), true)?>
		</div>
		<?php  endforeach;?>
