...
<div id="content">
	...
	<div class="box">
		...
		<div class="content">
			...
			<form id="admin-grid-form" action="<?php echo $this->createUrl('gridviewupdate')?>" method="post">
						...
						'columns' => array(
							...
							*/
							...
							array(
								'type' => 'raw',
								'name' => 'status',
								'value' => 'CHtml::dropDownList("edit[$data->admin_id][status]", $data->status, array("0"=>Yii::t("app", "No"), "1"=>Yii::t("app", "Yes")), array("class"=>"editable"))',
