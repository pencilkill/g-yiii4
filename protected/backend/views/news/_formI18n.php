<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <div class="buttons">
      	<a onclick="$('#news-form').submit();" class="button"><?php  echo Yii::t('app', 'Save'); ?></a>
    ...
    <div class="content">
		...
		<div id="tab-language-<?php  echo $val['language_id']?>">
			<?php  echo $this->renderPartial('//newsI18n/_i18n', array('form' => $form, 'model' => $i18ns[$val['language_id']], 'language_id' => $val['language_id']), true)?>
		</div>
		<?php  endforeach;?>
