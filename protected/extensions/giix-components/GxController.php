...
abstract class GxController extends Controller {
	...
	/**
	 * Performs the AJAX validation for multiple models in on form.
	 * #MethodTracker
	 * This method is based on the gii generated method controller::performAjaxValidation, from version 1.1.7 (r3135). Changes:
	 * <ul>
	 * <li>Supports multiple models from different or same models.</li>
	 * </ul>
	 * @param array assoc array of models to be validated.
	 * @param string $form The name of the form. Optional.
	 */
	protected function performAjaxValidationEx($model, $form = null) {
		if (Yii::app()->getRequest()->getIsAjaxRequest() && (($form === null) || ($_POST['ajax'] == $form))) {
			echo GxActiveForm::validateEx($model);
			Yii::app()->end();
		}
	}
